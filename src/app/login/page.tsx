      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface rounded-xl border border-low-contrast p-8 md:p-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Primary Action */}
            <button className="w-full bg-primary text-white font-semibold text-sm rounded py-4 mt-8 hover:bg-opacity-90 transition-colors flex items-center justify-center gap-2 cursor-pointer" type="submit">
              Sign In
          ...
          <button
            ...
            className="w-full bg-surface-container-lowest border border-border-low-contrast text-on-surface font-semibold text-sm rounded py-4 hover:bg-surface-container-low transition-colors flex items-center justify-center gap-3 cursor-pointer"
          >
          ...
          <div className="mt-8 text-center">
            <p className="font-body text-sm text-on-surface-variant">
              ...
              <a className="text-primary font-medium hover:text-secondary transition-colors underline decoration-border-low-contrast underline-offset-4" href="#">
                Sign up
              </a>
            </p>
          </div>
